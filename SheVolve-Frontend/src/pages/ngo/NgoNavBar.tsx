            ...
            <div className="admin-navbar-container">
                ...
                <ul className="admin-navbar-menu">
                    <li className="admin-navbar-item">
                        <Link to="/ngo/mentors" className="admin-navbar-link">Mentors</Link>
                    </li>
                    <li className="admin-navbar-item">
                        <Link to="/ngo/analysis" className="admin-navbar-link">Performance Analysis</Link>
                    </li>
                    <li className="admin-navbar-item">
                        <Link to="/ngo/resources" className="admin-navbar-link">Resources</Link>
                    </li>
                </ul>
